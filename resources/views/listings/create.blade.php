            ...
            <form action="{{ route('listings.store') }}" id="payment_form" method="post" enctype="multipart/form-data"
                ...
                <div class="mb-2 mx-2">
                    ...
                    <button type="submit" id="form_submit"
                        class="hover:animate-spin block w-full items-center bg-indigo-500 text-white border-0 py-2 focus:outline-none hover:bg-indigo-600 rounded text-base mt-4 md:mt-0">Pay
                        + Continue</button>
                </div>
            </form>
        </div>
